...
png(paste(destDirFigures, '07_transectSamplingFrequencyArchiveExtra.png', sep = '/'), width = 8, height = 4, units = 'in', pointsize = 9, res = 250)
...
save(cnttbl, df, file = '07_transectSamplingFrequencyArchiveExtra.rda')